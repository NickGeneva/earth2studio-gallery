...
class GalleryPlugin(BasePlugin):
    config_scheme = (
        ...
        ("cache_output_directory", config_options.Type(bool, default=False)),
        ("invalidate_on_lock_change", config_options.Type(bool, default=False)),
    ...
    def on_config(self, config, **kwargs):
        ...
        overrides = {
            ...
            "cache_output_directory": self.config["cache_output_directory"],
            "invalidate_on_lock_change": self.config["invalidate_on_lock_change"],
